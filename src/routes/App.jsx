...
import InstructorProfilePage from '../pages/Dashboard/Instructor/Profile/InstructorProfile';
function App() {
  return (
    <Router>
      <Routes>
...
{/*########################## Protected Routes For Instructor ##########################*/}
      ...
      <Route
        path='/dashboard/instructor/my-profile'
        element={
          <ProtectedRoute requiredRole="I">
...
{/*########################## Protected Routes For Student ##########################*/}
      ...
      <Route
        path='/dashboard/student/vehicle'
        element={
          <ProtectedRoute requiredRole="S">
            <StudentVehiclePage />
          </ProtectedRoute>
