...
import StudentDetailPage from './Studentdetailspage';
...
const InstructoreStudentsPage = () => {
  ...
  const fetchProfiles = useCallback(async () => {
    ...
    setError('');
    try {
      const data = await studentApi.getStudentProfiles(search);
...
export default InstructoreStudentsPage;